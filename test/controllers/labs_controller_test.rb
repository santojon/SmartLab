...
class LabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lab" do
    assert_difference('Lab.count') do
      post labs_url, params: { lab: { building: @lab.building, code: @lab.code, name: @lab.name } }
    end
  ...
  test "should update lab" do
    patch lab_url(@lab), params: { lab: { building: @lab.building, code: @lab.code, name: @lab.name } }
