...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { description: @equipment.description, model: @equipment.model, serial: @equipment.serial, tag: @equipment.tag } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { description: @equipment.description, model: @equipment.model, serial: @equipment.serial, tag: @equipment.tag } }
